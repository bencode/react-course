...
1. 在codepen中创建一个pen，使用React制作一个页面，页面内容不限，但有以下要求：

- 至少包含两个带参数的自定义组件。
- 至少有一个组件是基于数据模型来创建的，且模型清晰，定义合理。
- 包含条件渲染和循环渲染。
- 至少一次使用辅助函数, 比如格式化内容。
...
- [MDN button文档](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button)
